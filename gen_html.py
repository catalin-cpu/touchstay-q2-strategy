...
<head>
  ...
  <style>
    ...
    *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .modal-content {{ position: relative; width: 80vw; height: 80vh; display: flex; align-items: center; justify-content: center; }}
    .modal-img {{ max-width: 100%; max-height: 100%; width: auto; height: auto; object-fit: contain; display: block; }}
...
<div class="hero">
  ...
  <h1>Growing MRR 6% Through Smarter Conversion &amp; Upsell</h1>
  <p class="hero-sub">A CPO-to-Executive overview of the four strategic pillars driving Q2&apos;s growth targets, with a moonshot vision for what comes next.</p>
  <div class="hero-kpis">
...
<section id="summary">
  ...
  <div class="two-col">
    <div>
      <div class="sub-heading">New Account &amp; Upsell Targets</div>
    ...
    <div>
      <div class="sub-heading">Key Target Metrics</div>
      <div class="table-wrap">
        <table>
...
<section id="pillar-2">
  ...
  <div class="pillar-section">
    <div class="pillar-section-header">
      ...
      <div><h3>Tier Pricing Analysis</h3><p>New pricing creates stronger differentiation between tiers, making the upgrade economics clear to users.</p></div>
    </div>
    <div class="table-wrap">
      <table>
    ...
    <div class="two-col">
      <div>
        ...
        <ul class="bullet">
          ...
          <li>Pair with opt-in migration incentives and ROI Calculator to de-risk the ask</li>
        </ul>
      </div>
      <div>
        ...
        <ul class="bullet">
          ...
          <li>Store ROI Calculator positions Store as a business case, not just a feature</li>
...
<section id="pillar-3">
  ...
  <p class="sec-desc"><strong>60% of G3s</strong> skip OTA links &mdash; their guidebooks are never ready to share, so they churn during trial. AI-guided creation replicates the <strong>15pp conversion lift</strong> we see with auto-imported guidebooks.</p>
  <div class="pillar-section">
    <div class="pillar-section-header">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Replicate feature upgrade states Starter &rarr; Growth to Legacy &rarr; Tiered. 5-day trials, upgrade screen, intent signals to Pipedrive.</td>
        ...
        <tr>
          <td>3</td>
          <td>Upsell</td>
          <td>Store ROI Calculator Upgrade</td>
          <td>ROI calculator and upgrade form from Legacy to Tiers page</td>
        ...
        <tr>
          ...
          <td>Side-by-side chatbot + live guidebook preview. Chatbot mimics sign-up flow conversationally. Primary G1 driver.</td>
        ...
        <tr>
          ...
          <td>Opt-out SMS compliance for +1 numbers before any SMS is sent. Store opt-out flag on contact and invitation.</td>
        ...
        <tr>
          <td>7</td>
          <td>Message Hub</td>
          <td>Chatbot Escalation &amp; Notification</td>
        ...
        <tr>
          ...
          <td>Message Hub</td>
          <td>Train Chatbot</td>
          <td>Structured Q&amp;A list + document upload for chatbot training. Label by guidebook, org, or account level.</td>
        ...
        <tr>
          ...
          <td>Collaborative workflows to drive multi-seat need and Growth &rarr; Pro upgrades.</td>
        ...
        <tr>
          <td>13</td>
          <td>Upsell</td>
          <td>Split Campaign Manager</td>
          <td>Separate Campaign Manager between Starter and Growth. Store campaigns moved to Store section.</td>
